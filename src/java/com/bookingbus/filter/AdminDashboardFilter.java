...
public class AdminDashboardFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("AdminDashboardFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AdminDashboardFilter:DoAfterProcessing");
        }
        ...
        if (account == null) {
            ...
            if (account.getRoleId() == Constant.ROLE_ADMIN) {
                ...
                if (!req.getRequestURI().equals(req.getContextPath() + "/admin/dashboard")) {
                    resp.sendRedirect(req.getServletContext().getContextPath() + "/admin/dashboard?page=view-bus");
                }
            } else {
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("AdminDashboardFilter(");
