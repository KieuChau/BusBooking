...
public class DashboardFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (account == null) {
            if (!req.getRequestURI().equals(req.getContextPath() + "/authen")) {
                resp.sendRedirect(req.getServletContext().getContextPath() + "/authen?action=login");
            }
        } else {
            if (account.getRoleId() == Constant.ROLE_USER) {
                // If the role is user, redirect to the profile dashboard
                if (!req.getRequestURI().equals(req.getContextPath() + "/dashboard")) {
                    resp.sendRedirect(req.getServletContext().getContextPath() + "/dashboard?page=profile");
                }
            } else {
                if (!req.getRequestURI().equals(req.getContextPath() + "/home")) {
