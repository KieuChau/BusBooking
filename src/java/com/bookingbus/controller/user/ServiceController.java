        ...
        switch (action) {
            ...
            case "search":
                ...
                try {
                    ...
                    pagination.setUrlPattern("service?action=search&seat-quantity=" + seat + "&" + "take-time=" + takeTimeStr + "&" + "pickup-time=" + pickupTimeStr + "&");
                    break;
    ...
    private void bookingBus(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!isExist) {
            ...
            if (quantity <= remainingSeats) {
                ...
                int totalQuantityRemaining = busDAO.getTotalQuantityByBusId(busID);
                int quantityAfterBooking = totalQuantityRemaining - quantity;
                busDAO.updateQuantity(quantityAfterBooking ,busID);
